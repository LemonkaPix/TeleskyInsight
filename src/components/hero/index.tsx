...
const Hero = () => {
  return (
    <div className='heroWrapper w-full h-[50vh] sm:h-[60vh] flex justify-center items-center'>
      <div className='w-[95%] md:w-4/5 xl:w-3/5 h-[30vh] bg bg-opacity-80 bg-black rounded-tl-[34px] rounded-[34px] border-t border-r border-l border-gray-300 shadow-sm  mt-[90px]'>
